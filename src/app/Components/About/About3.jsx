...
const About3 = () => {
    return (
        ...
        <div className="about-wrapper section-padding  style3">
            ...
            <div className="shape2"><Image className="float-bob-x" src="/assets/img/shape/popularDishesShape1_2.png" alt="img" width={125} height={104}   /></div>
            ...
            <div className="container">
                <div className="row gx-60 gy-5">
                    <div className="col-xl-6">
                        ...
                        <Image src="/assets/img/about/aboutThumb1_1.png" alt="img" width={618} height={618}   />
                    ...
                    <div className="col-xl-6">
                        <div className="about-content">
                            <div className="title-area">
                                ...
                                <div className="text text-start wow fadeInUp" data-wow-delay="0.8s">Nutifafa Kitchen is all about good food, cooked the right way. We serve Nigerian, Ghanaian, and Caribbean meals made with fresh ingredients and real spices. No shortcuts. Just proper food that tastes like home.
                                </div>
                            </div>
                            ...
                            <Link href="/about" className="theme-btn style4">
