            ...
            <div className="history-wrapper style1">
                <div className="row gx-60">
                    <div className="col-lg-8">
                        ...
                        <Image className="thumb" src="/assets/img/history/historyThumb1_1.jpg" alt="img" width={1000} height={787}   />
                    ...
                    <div className="col-lg-4">
                        <div className="history-content section-padding">
                            ...
                            <div className="fancy-box style6">
                                ...
                                <div className="item">
                                    <h6 className="title">Real Home Taste</h6>
                                    <p className="text">Our food is cooked the traditional way, using real spices and fresh ingredients. It tastes like proper home food.
                                    </p>
                                </div>
                            </div>
                            <div className="fancy-box style6">
                                ...
                                <div className="item">
                                    <h6 className="title">Fresh & Filling</h6>
                                    <p className="text">Every meal is cooked fresh, with good portion sizes that leave you satisfied.
                                    </p>
                                </div>
                            </div>
                            <Link href="/shop" className="theme-btn style4">
