...
const HeroBanneer3 = () => {
    ...
    const heroContent = [
        {img:'/assets/img/shape/bannerShape3_3.png', subtitle:'nutifafa', title:'<span>TRUE</span> FLAVOUR', content:'From Nigerian classics to Ghanaian favourites and Jamaican dishes, Nutifafa Kitchen brings real home-style food to your table.', location:'Coventry, United Kingdom'},
        {img:'/assets/img/shape/bannerShape3_3.png', subtitle:'nutifafa', title:'<span>GOOD</span> FOOD', content:'From Nigerian classics to Ghanaian favourites and Jamaican dishes, Nutifafa Kitchen brings real home-style food to your table.', location:'Coventry, United Kingdom'},
        {img:'/assets/img/shape/bannerShape3_3.png', subtitle:'nutifafa', title:'<span>AFRICAN</span> TASTE', content:'From Nigerian classics to Ghanaian favourites and Jamaican dishes, Nutifafa Kitchen brings real home-style food to your table.', location:'Coventry, United Kingdom'},
                    ...
                    <div key={i} className="swiper-slide">
                        <div className="banner-wrapper style3 bg-img">
                            <div className="shape1  d-none d-xxl-block" data-animation="slideInLeft" data-duration="2s"
                                data-delay=".3s">
                                    <Image className="float-bob-y" src="/assets/img/shape/bannerShape2_4.svg" alt="img" width={191} height={146}   />
                                
                            </div>
                            <div className="shape2  d-none d-xxl-block" data-animation="slideInLeft" data-duration="2s"
                                data-delay=".5s">
                                    <Image className="float-bob-x" src="/assets/img/shape/chefeShape1_1.png" alt="img" width={304} height={218}   />
